...
export const tenants = Array.from({ length: 50 }, (_, i) => {
  ...
  return {
    ...
    gstNumber: i % 3 === 0 ? `29AABCU${9600 + i}Z1` : null,
    logo: null,
  }
})
...
export const subscriptionPlansAdmin = [
  {
    ...
    maxVehicles: 50,
    maxMechanics: 2,
    features: ['Job cards for 2W', 'Up to 100 jobs/month', '50 vehicles', '2 mechanics', 'Email support'],
  ...
  },
  {
    ...
    maxVehicles: 100,
    maxMechanics: 4,
    features: ['Unlimited job cards', '150 jobs/month', 'Inventory for parts', 'Basic reports', 'WhatsApp reminders'],
  ...
  },
  {
    ...
    maxVehicles: 100,
    maxMechanics: 5,
    features: ['4 Wheeler job cards', '200 jobs/month', 'Parts inventory', 'Monthly reports', 'Customer history'],
    inventoryEnabled: true,
    reportsEnabled: true,
    multiBranchEnabled: false,
    status: 'Active',
  },
  {
    ...
    maxVehicles: 300,
    maxMechanics: 15,
    features: ['Full workshop suite', '500 jobs/month', 'Inventory & reports', 'Multi-branch', 'Priority support'],
    inventoryEnabled: true,
    reportsEnabled: true,
  ...
  },
  {
    ...
    maxVehicles: 150,
    maxMechanics: 8,
    features: ['2W & 4W job cards', '300 jobs/month', 'Inventory & reports', 'Multi-branch', 'WhatsApp alerts'],
    inventoryEnabled: true,
    reportsEnabled: true,
    multiBranchEnabled: true,
    status: 'Active',
  },
  {
    ...
    maxVehicles: 500,
    maxMechanics: 25,
    features: ['All vehicle types', '1000 jobs/month', 'Full inventory', 'Reports & analytics', 'Multi-branch', 'Dedicated support'],
    inventoryEnabled: true,
    reportsEnabled: true,
    multiBranchEnabled: true,
    status: 'Active',
  ...
  {
    id: 'plan-heavy-m',
    planName: 'Heavy Fleet Basic',
    vehicleType: '4 Wheeler + Heavy Vehicle',
    duration: 'Monthly',
    price: 5999,
    maxJobsPerMonth: 500,
    maxVehicles: 200,
    maxMechanics: 10,
    features: ['Heavy vehicle job cards', 'Fleet management', 'Priority support', 'Parts inventory', 'Maintenance schedule'],
    inventoryEnabled: true,
    reportsEnabled: true,
    multiBranchEnabled: false,
    status: 'Active',
  },
  {
    ...
    maxVehicles: 1000,
    maxMechanics: 50,
    features: ['Custom heavy workflows', 'Multi-branch fleet', 'Advanced analytics', 'VIP support', 'Telematics integration'],
    inventoryEnabled: true,
    reportsEnabled: true,
    multiBranchEnabled: true,
    status: 'Active',
